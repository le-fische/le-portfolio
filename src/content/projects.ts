...
export const projects: Project[] = [
  ...
  },
  {
    ...
    summary:
      "Nine days, a 465-entrant field, and a chess engine written from scratch in Python. Numba got the search to 2.7M nodes a second. Finished 191st of 465, peak rating 1835.",
    year: "2026",
    ...
    blocks: [
      ...
      },
      {
        ...
        caption: "Official competition dashboard — final standing across 109 rated rounds",
        wide: true,
      },
      {
        kind: "specs",
        ...
        rows: [
          ...
          { label: "Placement", value: "191st of 465" },
          { label: "Peak / final", value: "1835 / 1699" },
          { label: "Rated rounds", value: "109" },
          { label: "Record", value: "43-29-42" },
          { label: "Best streak", value: "5" },
          { label: "Checkmates", value: "42" },
