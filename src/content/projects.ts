...
export const projects: Project[] = [
  ...
  },
  {
    ...
    summary:
      "Nine days, a 465-entrant field, and a chess engine written from scratch in Python. Numba got the search to 2.7M nodes a second. Placed 135th of 334 in the 13-round qualifying Swiss, a point and a half short of a London seat.",
    year: "2026",
    ...
    cover: {
      kind: "image",
      src: "/work/chess-swiss.jpg",
      width: 1700,
      height: 956,
      alt: "Final qualification Swiss score distribution with the London cut marked",
    },
    blocks: [
      {
        kind: "image",
      ...
      },
      {
        ...
        width: 1700,
        height: 956,
        alt: "Score distribution across 334 entries in the final qualification Swiss, with the engine at 7.0 and the London cut at 8.5",
        caption: "Final qualification Swiss — 135th of 334; the London cut fell at 8.5 points",
        wide: true,
      },
      {
        kind: "list",
      ...
      },
      {
        ...
        width: 1800,
        height: 1182,
        alt: "Official competition dashboard showing rank 191 of 465, rating 1699, peak 1835",
        caption: "Ladder standing — rank 191 of 465 seeded the Swiss draw; it did not decide seats",
        wide: true,
      },
      {
        kind: "specs",
        ...
        rows: [
          { label: "Ladder seed", value: "191 / 465" },
          { label: "Swiss placing", value: "135 / 334" },
          { label: "Swiss score", value: "7.0 / 13" },
          { label: "Record", value: "5-4-4" },
          { label: "Performance", value: "1785" },
